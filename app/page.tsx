      ...
      <main className="bg-white">
        ...
        <section className="max-w-5xl mx-auto px-4 pt-20 pb-16 sm:pt-28 sm:pb-20 text-center">
          ...
          <p className="mt-5 text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            Upload a CSV of LinkedIn profiles, define what a great fit looks
            like, and get a ranked, enriched list ready to work — in minutes.
          </p>
        ...
        <section className="max-w-5xl mx-auto px-4 py-16 sm:py-20">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {FEATURES.map(({ title, desc, icon, badge }) => (
              <div
                key={title}
                className="relative flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-100"
              >
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {badge && (
                      <span
                        className={`text-[10px] font-semibold border px-1.5 py-0.5 rounded-full ${BADGE_CLASS[badge] ?? BADGE_CLASS['Starter+']}`}
                      >
                        {badge}
                      </span>
                    )}
